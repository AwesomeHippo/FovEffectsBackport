# FOV Effects Backport (Forge - 1.7.10)
...
<strong>A 1.7.10 backport of the FOV Effects slider. Configurable from 0 to 100% in Video Settings just like modern versions.</strong>

## Version
<span>
This branch is for <strong>Forge 1.7.10</strong>. Check other branches for the other versions/loaders.
</span>
